		...
		<div>
			...
			<div className="main ">
				<div className="container">
					<div className="flex justify-center items-center h-screen w-screen flex-col gap-4 px-6 overflow-hidden">
						<h1 className=" text-4xl md:text-6xl md:w-[600px] text-center  animate-appear">
						...
						<p className=" animate-appear">Vuelva más tarde :)</p>
						<div className="absolute top-0 left-0 text-4xl md:text-7xl font-bold opacity-10 text-justify h-screen w-screen overflow-hidden">
